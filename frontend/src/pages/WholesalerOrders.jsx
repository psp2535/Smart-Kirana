                            ...
                            return (
                                <button
                                    ...
                                    className={`flex items-center space-x-2 px-4 py-3 border-b-2 font-medium text-sm whitespace-nowrap transition-colors ${isActive
                                            ? 'border-black dark:border-white text-black dark:text-white dark:text-black dark:text-white'
                                ...
                                >
                                    ...
                                    {count > 0 && (
                                        <span className={`px-2 py-0.5 text-xs font-semibold rounded-full ${isActive
                                                ? 'bg-neutral-200 dark:bg-neutral-700 text-neutral-800 dark:text-neutral-200 dark:bg-primary-900 dark:text-primary-200'
                        ...
                        getOrdersByStatus(activeTab).map((order) => (
                            <div key={order._id} className="bg-white dark:bg-gray-800 rounded-lg shadow p-6">
                                ...
                                {order.status === 'ACCEPTED' && (
                                    <button onClick={() => updateOrderStatus(order._id, 'PACKED', 'Order packed and ready')} className="w-full px-4 py-2 bg-black dark:bg-white text-white dark:text-black dark:text-black rounded-lg hover:bg-neutral-800 dark:hover:bg-neutral-200 flex items-center justify-center space-x-2">
                                        <Package className="h-5 w-5" /><span>Mark as Packed</span>
                                    </button>
                                )}

                                {order.status === 'PACKED' && (
                                    <button onClick={() => updateOrderStatus(order._id, 'DISPATCHED', 'Order dispatched for delivery')} className="w-full px-4 py-2 bg-black dark:bg-white text-white dark:text-black dark:text-black rounded-lg hover:bg-neutral-800 dark:hover:bg-neutral-200 flex items-center justify-center space-x-2">
