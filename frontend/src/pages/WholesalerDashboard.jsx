        ...
        <div className="min-h-screen bg-gray-50 dark:bg-gray-900">
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
                    <div className="flex justify-between items-center">
                        ...
                        <div className="flex items-center space-x-4">
                            <button onClick={() => navigate('/wholesaler/profile-settings')} className="p-2 text-gray-600 dark:text-gray-300 hover:text-black dark:text-white"><Settings className="h-6 w-6" /></button>
                            <button onClick={handleLogout} className="flex items-center space-x-2 px-4 py-2 bg-black dark:bg-white text-white dark:text-black rounded-md hover:bg-red-700"><LogOut className="h-5 w-5" /><span>Logout</span></button>
                        </div>
                    </div>
                </div>
            </header>
            ...
            <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
                    <button onClick={() => navigate('/wholesaler/ai-insights')} className="bg-black dark:bg-white text-white dark:text-black dark:text-black rounded-lg shadow-lg p-6 hover:shadow-xl transition-shadow text-white">
                    ...
                    <button onClick={() => navigate('/wholesaler/inventory')} className="bg-white dark:bg-gray-800 rounded-lg shadow p-6 hover:shadow-lg transition-shadow">
                        <Package className="h-8 w-8 text-black dark:text-white mb-3" />
                    ...
                    <button onClick={() => navigate('/wholesaler/orders')} className="bg-white dark:bg-gray-800 rounded-lg shadow p-6 hover:shadow-lg transition-shadow">
                        <ShoppingCart className="h-8 w-8 text-black dark:text-white mb-3" />
