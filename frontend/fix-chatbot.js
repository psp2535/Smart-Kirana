...
filePaths.forEach(filePath => {
    ...
    const hues = ['blue', 'indigo', 'green', 'purple', 'red', 'yellow', 'orange', 'primary'];

    hues.forEach(hue => {
        if (hue === 'primary') {
            content = content.replace(/\btext-primary-[456]00\b/g, 'text-black dark:text-white');
            content = content.replace(/\btext-primary-[89]00\b/g, 'text-black dark:text-white');
            ...
            content = content.replace(/\bbg-primary-600\b/g, 'bg-black dark:bg-white');
        ...
        content = content.replace(new RegExp(`\\btext-${hue}-[89]00\\b`, 'g'), 'text-black dark:text-white');
        ...
        content = content.replace(new RegExp(`\\btext-${hue}-100\\b`, 'g'), 'text-white dark:text-black');
...
console.log('Fixed Assistant widgets');
